...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="bg-white rounded-xl border border-slate-200 px-5 py-3 text-center">
            ...
            <p class="text-2xl font-black text-[#1e3a6e]">{{ $ebooks->count() }}</p>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="bg-white rounded-2xl border {{ $buku->terbuka ? 'border-slate-200' : 'border-slate-100' }} p-5 flex flex-col sm:flex-row sm:items-center gap-5 transition-all duration-300 {{ $buku->terbuka ? 'hover:shadow-lg hover:-translate-y-1 hover:border-blue-300' : 'opacity-75' }}">
            ...
            <div class="w-14 h-14 rounded-full flex-shrink-0 flex items-center justify-center font-black shadow-inner border-2
                ...
                @else
                    <span class="text-lg">{{ $buku->level }}</span>
                @endif
            </div>
            ...
            <div class="flex-1">
                ...
                <h3 class="font-black text-slate-800 text-lg leading-tight">{{ $buku->judul }}</h3>
                <p class="text-sm text-slate-500 line-clamp-2 mt-1 leading-relaxed">{{ $buku->deskripsi }}</p>
            </div>
