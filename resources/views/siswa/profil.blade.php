...
<div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="px-6 py-6 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $siswa->siswaProfile?->tempat_lahir) }}" placeholder="Kota kelahiran"
                               class="w-full border border-slate-200 focus:border-[#1e3a6e] focus:ring-2 focus:ring-[#1e3a6e]/10
                                      rounded-xl px-4 py-2.5 text-slate-800 font-medium focus:outline-none transition text-sm">
                    </div>
                    <div>
    ...
    <div class="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-xl px-5 py-4">
        ...
        <p class="text-xs text-[#1e3a6e]/80 font-medium leading-relaxed">
            Data <strong>Kelas</strong> dan <strong>Jurusan</strong> hanya dapat diubah oleh Admin sekolah. Untuk perubahan tersebut, hubungi tata usaha sekolah.
        </p>
    </div>
