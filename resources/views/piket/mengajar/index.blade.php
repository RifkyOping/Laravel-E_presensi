...
<div class="space-y-6">
    ...
    <div x-data="{ showFilter: {{ $hasFilter ? 'true' : 'false' }} }" class="app-card p-6 animate-up">
        ...
        <div x-show="showFilter" x-transition class="mt-5 pt-5 border-t border-slate-100" style="display: none;">
            <form method="GET" action="{{ route('piket.mengajar.index') }}" class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div>
            ...
            <div class="p-4 space-y-2">
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
                        ...
                        <p class="text-[.65rem] text-slate-400 mt-1">{{ Carbon::parse($item->tanggal)->translatedFormat('d F Y') }}</p>
                    </div>
