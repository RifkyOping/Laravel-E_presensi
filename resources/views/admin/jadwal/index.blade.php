...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-6">
        <form method="GET" action="{{ route('admin.jadwal-mengajar.index') }}" class="flex gap-3">
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="border-b border-slate-100 bg-slate-50/70">
                        ...
                        <th class="py-3 px-5 text-[.7rem] font-black text-slate-400 uppercase tracking-wider">Nama Guru</th>
                        <th class="py-3 px-5 text-[.7rem] font-black text-slate-400 uppercase tracking-wider">Email</th>
                        <th class="py-3 px-5 text-[.7rem] font-black text-slate-400 uppercase tracking-wider">Status Jadwal</th>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/60 transition duration-150">
                        <td class="py-3.5 px-5 text-sm text-slate-400 font-semibold">{{ $gurus->firstItem() + $i }}</td>
                        ...
                        <td class="py-3.5 px-5 text-sm text-slate-500">{{ $guru->email }}</td>
                        <td class="py-3.5 px-5">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="py-12 text-center text-slate-400 text-sm">Tidak ada guru ditemukan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
