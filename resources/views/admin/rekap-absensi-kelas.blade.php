...
<div class="space-y-7">
    ...
    <div x-data="{ 
        showFilter: localStorage.getItem('filter_admin_rekap_absensi_kelas') === 'true' || {{ $hasFilter ? 'true' : 'false' }} 
    }" 
    x-init="$watch('showFilter', val => localStorage.setItem('filter_admin_rekap_absensi_kelas', val))"
