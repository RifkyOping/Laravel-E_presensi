    ...
    <div class="space-y-7">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-4">
            ...
            @foreach($stats_display as $s)
                <div
                    class="bg-white rounded-xl border border-slate-200 p-5 flex flex-col gap-3 transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                @foreach($menus as $m)
                    <a href="{{ $m['href'] }}" class="group bg-white rounded-xl border border-slate-200 p-5 flex flex-col gap-3
