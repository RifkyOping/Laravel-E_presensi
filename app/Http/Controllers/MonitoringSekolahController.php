...
class MonitoringSekolahController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        $stats = Cache::remember('monitoring_sekolah_stats', 600, function () use ($today) {
        ...
        // 2. Data Grafik
        $chartDataKey = 'monitoring_sekolah_chart_' . $filter . '_' . $bulan . '_' . $tahun;
        $chartData = Cache::remember($chartDataKey, 600, function () use ($filter, $bulan, $tahun) {
            $chartData = [
                'labels' => [],
                'guru' => [],
                'siswa' => [],
